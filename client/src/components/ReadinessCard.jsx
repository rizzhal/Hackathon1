...
const ReadinessCard = ({ score }) => {
  ...
  return (
    ...
    >
      <Card className="group overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl transition-all duration-300 hover:border-green-500/40 hover:shadow-[0_0_40px_rgba(34,197,94,0.25)]">
